import { DateUtils ,   CoreComponentAjaxUtils } from 'core-client-commons';
import { isNull, LocaleDefinition, I18nText  } from 'base-commons-module';
...
export function getI18nConfiguration (): I18nConfig {
    let locales:  LocaleDefinition[] = SecurityRelatedUtil.getLocales() ; 
    ...
    let s: any = null ; 
    let selectedLocale: LocaleDefinition = s ; 
    if ( !isNull(locales)) {
