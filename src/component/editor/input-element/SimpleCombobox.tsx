import { isNull   , CommonLookupValue , ObjectUtils } from 'base-commons-module';
import { ListOfValueManager , LOVEnabledComponent  } from 'core-client-commons';
...
export class SimpleCombobox extends BaseHtmlComponent<SimpleComboboxProps , SimpleComboboxState> implements LOVEnabledComponent {
     ...
     */
    private renderOption (lookup: CommonLookupValue): JSX.Element {
