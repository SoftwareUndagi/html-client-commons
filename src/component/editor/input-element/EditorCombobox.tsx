...
export interface LookupComboOptionProps extends React.Props<LookupComboOption> , BaseHtmlComponentProps {
    lookupValue: CommonCommunicationData.CommonLookupValue ; 
...
export interface EditorComboboxProps extends React.Props<EditorCombobox> {
     ...
     */
    readonlyLabelFormatter ?: (lookup: CommonCommunicationData.CommonLookupValue) => string ;
    /**
...
export class EditorCombobox extends BaseHtmlComponent<EditorComboboxProps , EditorComboboxState> implements EditorInputElement {
     ...
     * 
     */
    readonlyLabelFormatter:  (lookup: CommonCommunicationData.CommonLookupValue) => string  = EditorCombobox.FORMATTER_READONLY  ; 
    /**
     * formatter untuk combo box label
     */
    comboLabelFormatter:  (lookup: CommonCommunicationData.CommonLookupValue) => string  = EditorCombobox.FORMATTER_COMBO_LABEL ;
    /**
     ...
     */
    static FORMATTER_READONLY:  (lookup: CommonCommunicationData.CommonLookupValue) => string =  (lookup: CommonCommunicationData.CommonLookupValue)  => {
     ...
     */
    static FORMATTER_COMBO_LABEL:  (lookup: CommonCommunicationData.CommonLookupValue) => string =  (lookup: CommonCommunicationData.CommonLookupValue)  => {
    ...
    fetchDataFromControl (data: any ) {
        ...
        if ( isNull(this.props.appendNoneSelected) || !this.props.appendNoneSelected) {
            let rawData: CommonCommunicationData.CommonLookupValue[] = this.props.lookupContainers[this.props.lookupCode];
        ...
        if ( this.props.fieldNameForLOVLabel != null && typeof this.props.fieldNameForLOVLabel !== 'undefined') {
            ...
            let lks: CommonCommunicationData.CommonLookupValue[] = this.props.lookupContainers[this.props.lookupCode] || null ;
            if ( lks == null ) {
                lks = [] ; 
            }
            for ( var v of lks) {
    ...
    rendererTaskReadonlySpan () {
        let lkp: CommonCommunicationData.CommonLookupValue  = null! ; 
            ...
            changeHandler={(val: string ) => {
                this.setStateHelper ( 
                    ...
                    if ( !isNull(this.props.changeHandlerWithLookup)) {
                        let l2:  CommonCommunicationData.CommonLookupValue = null! ; 
                        let theLooks: CommonCommunicationData.CommonLookupValue[] = this.props.lookupContainers[this.props.lookupCode] ;
                        if ( !isNull(theLooks)) {
