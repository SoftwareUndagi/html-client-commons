...
export namespace ListOfValueComponent {
     ...
     */
    export interface LOVManager extends ListOfValueManager {
    ...
    export class ListOfValueManagerWebBased extends BaseListOfValueManager implements ListOfValueManager {
         ...
         */
        constructor(ajaxUtils: CoreAjaxHelper , public lookupContainers ?: {[id: string]: CommonCommunicationData.CommonLookupValue[] }) {
         ...
         */
        assignLookupDataToControlWorker(id: string, lovs: CommonCommunicationData.CommonLookupValue[]) {
            ...
            if (lovs != null && typeof lovs !== 'undefined') {
                ...
                if (lovComps != null) {
                    for (var cLov of lovComps) {
                        ...
                        if ( !isNull(d[ListOfValueComponent.ListOfValueManagerWebBased.RELOAD_NON_NATIVE_COMPONENT_METHOD])  ) {
                            try {
                                d[ListOfValueComponent.ListOfValueManagerWebBased.RELOAD_NON_NATIVE_COMPONENT_METHOD]() ;
                            } catch ( exc) {
         ...
         * @param lookupData
         */
        sendToCache(lookupData: CommonCommunicationData.CommonLookupHeader) {
        ...
        private generateStorageKey ( id: string ): string {
            ...
            return prfx + ListOfValueComponent.ListOfValueManagerWebBased.PREFIX_FOR_LOV_LOCAL_STORAGE + id ; 
        }
     ...
     * @param ajaxUtils 
     */
    export function  generateLookupManager ( ajaxUtils ?: CoreAjaxHelper , lookupContainers ?: {[id: string]: CommonCommunicationData.CommonLookupValue[] } ): ListOfValueManager {
        let s: any = ajaxUtils ; 
        if ( isNull(s)) {
