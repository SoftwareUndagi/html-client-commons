...
export interface EditorComboboxWrapperProps {
     ...
     */
    defaultLookupValues?: CommonCommunicationData.CommonLookupValue[];  
    /**
...
export class EditorComboboxWrapper  extends BaseHtmlComponent<EditorComboboxWrapperProps , EditorComboboxWrapperState> {
    ...
    render () {
        let opts: any[] = [] ; 
        let dataFilter:   (lookup: CommonCommunicationData.CommonLookupValue) => boolean = (lookup: CommonCommunicationData.CommonLookupValue) => {
            return true ; 
        };
        if ( this.props.dataFilter !== null && typeof this.props.dataFilter !== 'undefined') {
            dataFilter = this.props.dataFilter ; 
        }
        let lks: CommonCommunicationData.CommonLookupValue[] = !isNull(this.props.lookupContainers) ?  this.props.lookupContainers[this.props.lookupCode] : null!  ;
        if (isNull(lks)) {
